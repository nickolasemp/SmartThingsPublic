 ...
 */
metadata {
   definition (name: "Xiaomi Mijia Door/Window Sensor", namespace: "bspranger", author: "bspranger") {
   ...
   tiles(scale: 2) {
        multiAttributeTile(name:"contact", type: "generic", width: 6, height: 4){
            tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
                attributeState "open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#e86d13" // e86d13 -> blue 
                attributeState "closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#ffffff" //79b821-> green
            }
